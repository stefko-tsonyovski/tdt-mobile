...
export const DeleteLeague: FC<DeleteLeagueProps> = ({ inputModel }) => {
    ...
    <View>
      ...
      <Portal>
        <Dialog visible={visible} onDismiss={hideDialog}>
          <Dialog.Title>Delete {inputModel.name}?</Dialog.Title>
          <Dialog.Content>
            <Spacer position="top" size="large">
              <Text variant="body">
                You are going to delete {inputModel.name}. Are you sure you want
                to proceed?
              </Text>
            </Spacer>
          </Dialog.Content>
